...
public interface TagDAO {
    ...
    @NonNull List<Tag> getListTagsByGiftCertificateId(@NonNull Long id) throws RepositoryException;
    @NonNull Long create(@NonNull Tag tag) throws RepositoryException;
