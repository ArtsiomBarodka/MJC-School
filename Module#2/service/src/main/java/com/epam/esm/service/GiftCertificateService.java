...
public interface GiftCertificateService {
    ...
    @NonNull Long create(@NonNull GiftCertificate giftCertificate) throws ServiceException, ResourceAlreadyExistException;
    @NonNull GiftCertificate update(@NonNull GiftCertificate giftCertificate, @NonNull Long id) throws ServiceException, ResourceNotFoundException;
